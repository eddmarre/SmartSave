...
public class AccountUserExpense extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void EnterExpense(View view) {
        ...
        if (isDaily) {
            ...
            Intent intent = new Intent(getApplicationContext(), notificationRecieverExpense.class);
        ...
        if (isWeekly) {
            ...
            Intent intent = new Intent(this, notificationRecieverExpense.class);
        ...
        if (isMonthly) {
            ...
            AlarmManager alarmManager = (AlarmManager) getSystemService(ALARM_SERVICE);
            alarmManager.setRepeating(AlarmManager.RTC_WAKEUP, calender.getTimeInMillis(), AlarmManager.INTERVAL_DAY * 30, pendingIntent);
        }
