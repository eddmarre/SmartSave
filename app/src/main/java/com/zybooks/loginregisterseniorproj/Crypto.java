...
public class Crypto extends AppCompatActivity {
    ...
    private ArrayList<CryptoCurrencyModel> currencyModalArrayList;
    private CryptoCurrencyRVAdapter currencyRVAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currencyRVAdapter = new CryptoCurrencyRVAdapter(currencyModalArrayList, this);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(Crypto.this, "Something went amiss. Please try again later", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public Map<String, String> getHeaders() {
                ...
                headers.put("X-CMC_PRO_API_KEY", "4422cfb3-4921-4890-bd67-b030384d50f6");
